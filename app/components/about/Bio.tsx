...
const Bio = () => {
  ...
  return (
    <div className="flex flex-col items-center mb-10 px-[5%]">
      ...
      {showMore && (
        <div className="w-[980px] text-gLightBlue text-justify">
          <ul>
            <li>
            ...
            <br />
            <li>
              💬 Let's team up, dream big, and code our way into the future! Hit
              me up, I'm always down for a chat about tech, coding, or the
      ...
      {showMore ? (
        <div
          className="text-6xl cursor-pointer hover:text-gLightBlue px-2 "
